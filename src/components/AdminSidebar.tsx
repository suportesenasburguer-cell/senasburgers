...
type AdminTab = 'products' | 'categories' | 'upsells' | 'promotions' | 'addons' | 'rewards' | 'coupons' | 'banners' | 'neighborhoods' | 'users' | 'drivers' | 'store_hours';
...
const menuItems: { tab: AdminTab; label: string; icon: typeof Package }[] = [
  ...
  { tab: 'banners', label: 'Vitrine / Slides', icon: ImageIcon },
  ...
  { tab: 'store_hours', label: 'Horários da Loja', icon: Clock },
];
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate('/admin/entregadores')}>
                  <Truck className="h-4 w-4" />
                  <span>Gestão Entregadores</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarGroupContent>
