...
const Carrinho = () => {
  ...
  const handleFinalizarClick = () => {
    if (!storeOpen) {
      toast({
        title: 'Loja fechada',
        description: 'No momento não estamos aceitando pedidos. Nosso horário: Dom, Seg, Ter, Qui, Sex e Sáb das 18:15 às 23:00.',
        variant: 'destructive',
      });
      return;
    }
            ...
            <div className="bg-card rounded-2xl border border-border p-6">
              ...
              {!storeOpen && (
                <div className="flex items-center gap-2 mb-4 p-3 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive text-sm">
                  ...
                  <span>Estamos fechados no momento. Horário: Dom, Seg, Ter, Qui, Sex e Sáb das 18:15 às 23:00.</span>
                </div>
              )}
              ...
              <button
                ...
                className={cn(
                  ...
                  storeOpen
                    ? "gradient-burger text-primary-foreground hover:scale-[1.02] active:scale-[0.98]"
