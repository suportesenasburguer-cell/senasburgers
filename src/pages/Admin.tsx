...
const Admin = () => {
  ...
  const [activeTab, setActiveTab] = useState<'products' | 'categories' | 'upsells' | 'promotions' | 'addons' | 'rewards' | 'coupons' | 'banners' | 'neighborhoods' | 'users' | 'drivers' | 'store_hours'>('products');
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background">
        ...
        {/* STORE HOURS TAB */}
        {activeTab === 'store_hours' && <StoreHoursTab />}
          </div>
        </main>
      </div>
    </SidebarProvider>
